...
class CI_Pagination {
	...
	var $cur_tag_open		= '<li class="disabled">';
	...
	function create_links()
	{
		...
		if  ($this->prev_link !== FALSE AND $this->cur_page != 1)
		{
			...
			{
				$output .= $this->prev_tag_open.'<li class=\'previous\'><a '.$this->anchor_class.'href="'.$this->first_url.'">'.$this->prev_link.'</a></li>'.$this->prev_tag_close;
			}
			else
			{
				$i = ($i == 0) ? '' : $this->prefix.$i.$this->suffix;
				$output .= $this->prev_tag_open.'<li class=\'previous\'><a '.$this->anchor_class.'href="'.$this->base_url.$i.'">'.$this->prev_link.'</a></li>'.$this->prev_tag_close;
			}
		...
		if ($this->next_link !== FALSE AND $this->cur_page < $num_pages)
		{
			...
			$output .= $this->next_tag_open.'<li class=\'next\'><a '.$this->anchor_class.'href="'.$this->base_url.$this->prefix.$i.$this->suffix.'">'.$this->next_link.'</a></li>'.$this->next_tag_close;
		}
