      ...
      <table class="table table-striped table-bordered tablesorter" id="tcontacts">
        <thead>
          <tr>
            ...
            <th><i class="icon-envelope"></i> 品牌</th>
            <th><i class="icon-envelope"></i> 車型</th>
          </tr>
        </thead>
        <tbody>
        <? foreach($datas as $data): ?>
          <tr>
            ...
            <td id="name_<?=$data['name']; ?>"><?=$data['name']; ?></td>
            <td id="name_<?=$data['type_name']; ?>"><?=$data['type_name']; ?></td>
          <? endforeach; ?>         
        </tbody>
      </table>
