...
class Cartype extends CI_Controller 
{
    ...
    public function index()
    {
        ...
        // exit;
        $datas = $this->car_model->get_all_type();
        $this->load->view('car/car_type', array(
            'datas' => $datas
        ));
    }
    ...
    public function add()
    {
        ...
        $this->load->view('car/car_type_add', array(
            'datas' => $datas
            ));
    }
    ...
    public function add_data()
    {
        ...
        $is_added = $this->car_model->add_type($this->input->post());
