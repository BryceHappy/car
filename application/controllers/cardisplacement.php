...
class Cardisplacement extends CI_Controller 
{
    ...
    public function index()
    {
        ...
        // exit;
        $datas = $this->car_model->get_all_displacement();
        $this->load->view('car/car_displacement', array(
            'datas' => $datas
        ));
    }
    ...
    public function add()
    {
        $this->load->view('car/car_displacement_add');
    }
    ...
    public function add_data()
    {
        ...
        // print_r($this->input->post('optionsRadios'));
        // exit;
        $is_added = $this->car_model->add_displacement($this->input->post());
